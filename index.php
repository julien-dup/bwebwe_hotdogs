        ...
        <div class="contain">
            <div class="description">
                <div class="containDesc">
                    ...
                    <p class="text">Nous vous apporterons notre célèbre stand de Hot-dogs Chez Vinc®. <br>Avec notre camion de Hot-dogs Chez Vinc, vous obtenez le meilleur du hot-dogs aux saveurs riches et surprenantes.<br> <br>Notre service de restauration de camions
                        de nourriture est disponible pour le Havre et son agglomération et est parfait pour: Événements d’entreprise Collectes de fonds Festivals et carnavals Anniversaire Mariage

                        <br><br> Si vous souhaitez que Vin'z organise votre événement avec nos délicieux hot-dogs, veuillez appeler Vincent au 909-289-0574. Qu’il s’agisse de 50 personnes ou de 1000 personnes, nous pouvons le faire pour votre événement,
                        fête, festival ou collecte de fonds!
                    </p>
                </div>
            </div>
            <div class="form">
